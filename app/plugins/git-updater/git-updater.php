...
if ( ! class_exists('Halftheory_Clean_Plugin_Git_Updater', false) ) :
	final class Halftheory_Clean_Plugin_Git_Updater {
		...
		public function __construct() {
			...
			} elseif ( ! is_admin() && function_exists('remove_filter_extended') ) {
				remove_filter_extended('rest_api_init', array( 'Fragen\GitHub_Updater\REST_API', 'register_endpoints' ));
			}
		}
		...
		private function get_plugin_version( $version = null ) {
			...
			foreach ( $this->plugin_locations as $location ) {
				if ( $hp ) {
