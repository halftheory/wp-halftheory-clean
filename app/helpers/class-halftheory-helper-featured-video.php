	...
	class Halftheory_Helper_Featured_Video {
        ...
        public function admin_enqueue_scripts() {
			...
			if ( method_exists('Halftheory_Clean', 'get_theme_version') ) {
				wp_enqueue_script($handle, get_template_directory_uri() . '/app/helpers/featured-video/media-editor-featured-video' . ( ! ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '.min' : '' ) . '.js', array( 'media-editor' ), Halftheory_Clean::get_instance()->get_theme_version(get_template_directory() . '/app/helpers/featured-video/media-editor-featured-video' . ( ! ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '.min' : '' ) . '.js'), true);
			} else {
				wp_enqueue_script($handle, get_template_directory_uri() . '/app/helpers/featured-video/media-editor-featured-video' . ( ! ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '.min' : '' ) . '.js', array( 'media-editor' ), '', true);
			}
        }
        ...
        public function get_post_video( $post = null ) {
        	...
        	$res = '<div class="post-video"><a class="post-video" href="' . esc_url(get_permalink($post)) . '" aria-hidden="true" data-content="' . esc_attr(strip_tags(get_the_title($post))) . '">' . $res . '</a></div>';
